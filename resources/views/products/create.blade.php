@extends('layouts.app')
@section('title','ເພີ່ມສິນຄ້າ')
@section('page_title','ເພີ່ມສິນຄ້າໃໝ່')
...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-800">ເພີ່ມສິນຄ້າໃໝ່</h2>
    </div>
    ...
    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" placeholder="PRD-001"
            ...
            <div>
                ...
                <input type="text" name="barcode" value="{{ old('barcode') }}" placeholder="8850000000000"
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="ໃສ່ຊື່ສິນຄ້າ"
        ...
        <div class="grid grid-cols-3 gap-5">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">ລາຄາທຶນ <span class="text-red-500">*</span></label>
                <input type="number" name="cost_price" value="{{ old('cost_price', 0) }}" min="0" step="0.01"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">ລາຄາຂາຍ <span class="text-red-500">*</span></label>
                <input type="number" name="selling_price" value="{{ old('selling_price', 0) }}" min="0" step="0.01"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">ເຕືອນຕ່ຳສຸດ <span class="text-red-500">*</span></label>
                <input type="number" name="min_stock_alert" value="{{ old('min_stock_alert', 10) }}" min="0"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="3" placeholder="ລາຍລະອຽດສິນຄ້າ..."
